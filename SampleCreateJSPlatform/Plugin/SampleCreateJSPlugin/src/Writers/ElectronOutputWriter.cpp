...
namespace JiboPixiJS
{
    ...
    FCM::Result ElectronOutputWriter::EndOutput()
    {
    ...
    FCM::Result ElectronOutputWriter::StartDocument(
    ...
    FCM::Result ElectronOutputWriter::StartDefineTimeline()
    {
        return FCM_SUCCESS;
    }
    
    
    FCM::Result ElectronOutputWriter::EndDefineTimeline(
                                                    FCM::U_Int32 resId,
    ...
    FCM::Result ElectronOutputWriter::StartDefineShape()
    {
    ...
    FCM::Result ElectronOutputWriter::EndDefineShape(FCM::U_Int32 resId)
    {
    ...
    FCM::Result ElectronOutputWriter::StartDefineFill()
    {
    ...
    FCM::Result ElectronOutputWriter::DefineSolidFillStyle(const DOM::Utils::COLOR& color)
    {
    ...
    FCM::Result ElectronOutputWriter::DefineBitmapFillStyle(
                                                        FCM::Boolean clipped,
    ...
    FCM::Result ElectronOutputWriter::StartDefineLinearGradientFillStyle(
    ...
    FCM::Result ElectronOutputWriter::SetKeyColorPoint(
    ...
    FCM::Result ElectronOutputWriter::EndDefineLinearGradientFillStyle()
    {
    ...
    FCM::Result ElectronOutputWriter::StartDefineRadialGradientFillStyle(
                                                                     DOM::FillStyle::GradientSpread spread,
                                                                     const DOM::Utils::MATRIX2D& matrix,
    ...
    FCM::Result ElectronOutputWriter::EndDefineRadialGradientFillStyle()
    {
        m_gradientColor->push_back(*m_stopPointArray);
        m_pathElem->push_back(*m_gradientColor);
    ...
    FCM::Result ElectronOutputWriter::StartDefineBoundary()
    {
    ...
    FCM::Result ElectronOutputWriter::SetSegment(const DOM::Utils::SEGMENT& segment)
    {
        if (m_firstSegment)
        {
    ...
    FCM::Result ElectronOutputWriter::EndDefineBoundary()
    {
    ...
    FCM::Result ElectronOutputWriter::StartDefineHole()
    {
        return StartDefinePath();
    }
    ...
    FCM::Result ElectronOutputWriter::EndDefineHole()
    {
        return EndDefinePath();
    }
    ...
    FCM::Result ElectronOutputWriter::StartDefineStrokeGroup()
    {
    ...
    FCM::Result ElectronOutputWriter::StartDefineSolidStrokeStyle(
    ...
    FCM::Result ElectronOutputWriter::EndDefineSolidStrokeStyle()
    {
        // No need to do anything
        return FCM_SUCCESS;
    }
    ...
    // Start of stroke
    FCM::Result ElectronOutputWriter::StartDefineStroke()
    {
        m_pathElem = new JSONNode(JSON_NODE);
        ASSERT(m_pathElem);
    ...
    // End of a stroke
    FCM::Result ElectronOutputWriter::EndDefineStroke()
    {
    ...
    // End of stroke group
    FCM::Result ElectronOutputWriter::EndDefineStrokeGroup()
    {
        // No need to do anything
        return FCM_SUCCESS;
    }
    ...
    FCM::Result ElectronOutputWriter::EndDefineFill()
    {
        m_pathElem->push_back(JSONNode("d", m_pathCmdStr));
    ...
    // Define a bitmap
    FCM::Result ElectronOutputWriter::DefineBitmap(
                                               FCM::U_Int32 resId,
                                               FCM::S_Int32 height,
                                               FCM::S_Int32 width,
                                               const std::string& libPathName,
    ...
    FCM::Result ElectronOutputWriter::StartDefineClassicText(
                                                         FCM::U_Int32 resId,
    ...
    FCM::Result ElectronOutputWriter::StartDefineParagraph(
    ...
    FCM::Result ElectronOutputWriter::StartDefineTextRun(
                                                     FCM::U_Int32 startIndex,
                                                     FCM::U_Int32 length,
    ...
    FCM::Result ElectronOutputWriter::EndDefineTextRun()
    {
        return FCM_SUCCESS;
    }
    
    
    FCM::Result ElectronOutputWriter::EndDefineParagraph()
    {
    ...
    FCM::Result ElectronOutputWriter::EndDefineClassicText()
    {
    ...
    FCM::Result ElectronOutputWriter::DefineSound(
                                              FCM::U_Int32 resId,
                                              const std::string& libPathName,
                                              DOM::LibraryItem::PIMediaItem pMediaItem)
    {
    ...
    FCM::Result ElectronOutputWriter::StartDefinePath()
    {
    ...
    FCM::Result ElectronOutputWriter::EndDefinePath()
    {
        // No need to do anything
        return FCM_SUCCESS;
    }
    
    FCM::Result ElectronOutputWriter::CreateImageFileName(const std::string& libPathName, std::string& name)
    {
        std::string str;
        size_t pos;
    ...
    FCM::Result ElectronOutputWriter::CreateSoundFileName(const std::string& libPathName, std::string& name)
    {
        std::string str;
        size_t pos;
        std::string fileLabel;
    ...
    FCM::Boolean ElectronOutputWriter::GetImageExportFileName(const std::string& libPathName, std::string& name)
    {
    ...
    void ElectronOutputWriter::SetImageExportFileName(const std::string& libPathName, const std::string& name)
    {
