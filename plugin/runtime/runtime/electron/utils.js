...
export default class Utils {
	static CreateShape(parentMC, resourceManager, charId, ObjectId, placeAfter, transform) {
	...
	static CreateBitmap(parentMC, resourceManager, charId, ObjectId, placeAfter, transform) {
	...
	static CreateText(parentMC, resourceManager, charId, ObjectId, placeAfter, transform) {
