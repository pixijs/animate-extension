...
#define PUBLISHER_NAME						"PixiJSPlugin"
#define PUBLISHER_UNIVERSAL_NAME			"PixiJSPlugin"

/* The value of the PUBLISH_SETTINGS_UI_ID has to be the HTML extension ID used for Publish settings dialog*/
#define PUBLISH_SETTINGS_UI_ID				"PixiJSPlugin.PublishSettings"

#define DOCTYPE_NAME						"PixiJSPlugin"
#define DOCTYPE_UNIVERSAL_NAME				"PixiJSPlugin"
